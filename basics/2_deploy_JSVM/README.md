...
1. Click the Deploy and Run icon ![deploy & run icon](https://github.com/ethereum/remix-workshops/blob/master/basics/2_deploy_JSVM/images/run.png "deploy & run icon").   But before you click it, make sure that ballot.sol is the active tab - which it should be if because you just compiled it.
...
6. You could install MetaMask now - or wait until you need it in another tutorial. 
